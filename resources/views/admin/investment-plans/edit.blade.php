                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('monthly_return_rate') is-invalid @enderror"
                                   id="monthly_return_rate" name="monthly_return_rate" value="{{ old('monthly_return_rate', $plan->monthly_return_rate ?? '') }}"
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="form-control bg-light" id="approx_daily_rate">
                                {{ $plan->monthly_return_rate > 0 ? number_format($plan->monthly_return_rate / 30, 4) . '%' : '—' }}
                            </div>
